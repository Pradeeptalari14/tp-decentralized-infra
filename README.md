# ⛓️ Decentralized Infrastructure Studio
> Monitor IPFS and blockchain nodes. Generate validator check scripts, peer discovery rules, and status alerts.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/decentralized-infra/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/decentralized-infra/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-decentralized-infra.git
cd tp-decentralized-infra
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/decentralized-infra/) |
